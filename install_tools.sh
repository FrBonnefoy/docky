...
sudo docker run -dit --name booking_info --network host --memory="4g" --memory-swap="6g" --cpus="0.625" --shm-size="4g" -v /home/azureuser/docky/big_urls:/Bookinfo  booking_info
